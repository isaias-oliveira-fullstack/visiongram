...
/**
 * Constantes do seletor de emojis
 * https://github.com/delowardev/vue3-emoji-picker/blob/main/src/constant.tsz
 */
...
// Foto de perfil padrão usada em todo o app quando o usuário não tem avatar
export const DEFAULT_PROFILE_PICTURE = new URL('../assets/default-avatar.svg', import.meta.url).href